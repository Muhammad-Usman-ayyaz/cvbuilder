      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-5 border-b border-border shrink-0 bg-bg-main/30">
          <div className="flex items-center gap-3 select-none">
            <div className="h-9 w-9 rounded-md bg-primary text-white flex items-center justify-center shrink-0">
              <span
          ...
          <button
            onClick={onClose}
            className="lg:hidden p-1.5 rounded-md text-text-secondary hover:text-text-primary hover:bg-bg-main transition-colors"
        ...
        <nav className="flex-grow px-3 py-4 space-y-6 overflow-y-auto">
            ...
            <div key={section.id} className="space-y-1">
              ...
              {section.items.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `group relative flex items-center gap-3 px-3.5 py-2.5 rounded-md text-sm font-medium transition-colors duration-200 ${isActive
                      ? 'bg-soft-primary text-primary font-semibold'
                ...
                >
                  {({ isActive }) => (
                    <>
                      ...
                      <span
                        className={`material-symbols-outlined text-[20px] shrink-0 transition-colors duration-200 ${isActive
                          ? 'text-primary'
          ...
          <div className="pt-2 border-t border-border/60">
            ...
            <button
              ...
              className="w-full group flex items-center gap-3 px-3.5 py-2.5 rounded-md text-sm font-medium text-text-secondary hover:bg-bg-main hover:text-text-primary transition-colors text-left"
            >
        ...
        <div className="px-3 py-2">
          <div className="p-3.5 rounded-md bg-bg-main border border-border relative overflow-hidden group">
        ...
        <div className="p-3 border-t border-border bg-bg-main/40 shrink-0">
          <div className="flex items-center gap-3 p-2 rounded-md hover:bg-bg-main transition-colors">
            <div className="relative shrink-0">
              <div className="h-9 w-9 rounded-md bg-primary text-white flex items-center justify-center font-bold text-xs shadow-sm">
            ...
            <button
              ...
              className="text-text-secondary hover:text-primary p-1 rounded-md hover:bg-card transition-colors"
