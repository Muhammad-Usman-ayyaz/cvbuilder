            ...
            <div className="mt-8 flex items-center justify-between pt-4 border-t border-border">
                ...
                {activeIndex < TABS.length - 1 ? (
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-medium bg-success text-white hover:bg-success/90 transition-colors shadow-sm ml-auto"
                    >
                        Finished
