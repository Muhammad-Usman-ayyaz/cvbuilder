...
export const TEMPLATES = [
    {
        ...
        metadataBadges: ['Single Column', 'ATS Friendly', 'Universal'],
        bestFor: 'Finance, Consulting, Law, Engineering & Traditional Roles',
        icon: 'article',
    ...
    },
    {
        id: 'modern',
        name: 'Modern',
        tagline: 'Contemporary & Dynamic',
        description: 'Bold header with a sidebar for skills and contact details.',
        metadataBadges: ['Two-Column', 'Sidebar Layout', 'High Impact'],
        bestFor: 'Tech, Startups, Product Management & Marketing',
        icon: 'view_sidebar',
    ...
    },
    {
        ...
        metadataBadges: ['Generous Whitespace', 'Modern Type', 'Clean Grid'],
        bestFor: 'Design, Creative, Architecture & Editorial Roles',
        icon: 'crop_free',
